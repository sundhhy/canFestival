...
//UNS8 canReceive(CAN_HANDLE, Message *)FCT_PTR_INIT;
//UNS8 canSend(CAN_HANDLE, Message const *)FCT_PTR_INIT;
//CAN_HANDLE canOpen(s_BOARD *)FCT_PTR_INIT;
//int canClose(CAN_HANDLE)FCT_PTR_INIT;
//UNS8 canChangeBaudRate(CAN_HANDLE, char *)FCT_PTR_INIT;
